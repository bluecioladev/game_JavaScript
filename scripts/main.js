window.addEventListener("load", function () {
  ...
  class Player {
    ...
    update() {
      ...
      //check for collisions whit obstacles
    ...
    draw(context) {
      ...
      if (this.game.debug) {
        ...
        context.fillText(
          displayTimer,
          this.collisionX,
          this.collisionY - this.collisionRadius * 2.6
        );
      }
    }
    update(deltaTime) {
  ...
  class Game {
    ...
    render(context, deltaTime) {
      if (this.timer > this.interval) {
        ...
        //render sort by vertical position
      ...
      if (this.debug) {
        context.fillText("lost " + this.losthatchlings, 25, 135);
      }
      context.restore();
      //win lose msg
      if (this.score >= this.winningScore) {
        ...
        if (this.losthatchlings <= 5) {
          //WIN
          msg1 = "Ganaste Perro...!!!";
          msg2 = " has Ganado tio joder...!!!";
        } else {
          //lose
          msg1 = "YOU LOSE BITCH....!!!";
          msg2 =
            "HASTA LA VISTA BAYBY..!!!" +
            this.losthatchlings +
            "sigue intentandolo  tio joder...";
        }
        context.font = "130 Bangers";
        context.fillText(msg1, this.width * 0.5, this.height * 0.5 - 30);
        context.font = "40 Bangers";
        context.fillText(msg2, this.width * 0.5, this.height * 0.5 + 40);
        context.fillText(
    ...
    removeGameobjects() {
      this.eggs = this.eggs.filter((object) => !object.markForDeletion);
